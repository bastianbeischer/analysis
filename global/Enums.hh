...
public:
  ...
  static const QVector<LikelihoodVariable> likelihoodVariableVector(LikelihoodVariables);
  static const QVector<LikelihoodVariable> likelihoodVariableVector(const QString);
